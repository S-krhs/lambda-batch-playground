// In scope: Discord interaction の署名検証・body 解釈・応答 payload 作成をオーケストレーションする
// Out of scope: Function URL envelope の検証、署名検証アルゴリズムや選択結果判定の詳細を持つ
...
export const discordInteractionJob = async (
	...
	if (interaction.type === INTERACTION_TYPE_MESSAGE_COMPONENT) {
		const response = handleMessageComponent(
